...
function LogoMobile () {
  return (
    <svg className='fill-kpurple md:hidden' width="25" height="25" viewBox='0 0 25 25' xmlns="http://www.w3.org/2000/svg">
      <g fillRule="evenodd">
...
export { LogoMobile, LogoDesktop, LogoLoading }
